...
function petals1(xx,yy){
   ...
   for (let i = 0; i < 25;i++){
    ...
    push()
       ...
       translate(i*cos(theta),j*sin(theta))
       //rotate(-theta*4)
       line(swayx[i]+xpos[i]-2,swayy[i]+ypos2[i]-10,swayx[i]+xpos[i]+4,swayy[i]+ypos2[i]+6)
...
function petals2(xx2,yy2){
   ...
   for (let i = 0; i < 25;i++){
    ...
    push()
       ...
       translate(i*cos(theta),j*sin(theta))
       line(swayx[i]+xpos2[i]+5,swayy[i]+ypos3[i]-11,swayx[i]+xpos2[i]-3,swayy[i]+ypos3[i]+8)
